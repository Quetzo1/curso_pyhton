...
def carga_archivo_texto(archivo:str)->list:
    '''
    Carga una lista de texto y devuelve una lista con las oraciones del archivo
    '''
...
if __name__=='__main__':
    ...
    despliega_plantillas(plantillas, 5)
    lista = carga_archivo_texto('.datos/pg15532.txt')
    lista_palabras = obten_palabras(lista)
